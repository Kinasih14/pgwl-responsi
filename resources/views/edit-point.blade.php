        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Halte</h1>
                ...
                <div class="modal-body">
                    <form action="{{ route('update-point', $id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="koridor" name="koridor" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layer.eachLayer(function(layer) {
                ...
                $('#koridor').val(layer.feature.properties.koridor);
                $('#alamat').val(layer.feature.properties.alamat);
                $('#geom_point').val(wkt);
        ...
        var point = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                var popupContent =
                    "<div style='background-color: B0C4DE;, color: B0C4DE, padding: 30px; border-radius: 5px;'>"  +
                    "Nama: " + feature.properties.name + "<br>" +
                    "Koridor: " + feature.properties.koridor + "<br>" +
